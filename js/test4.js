const url =  "http://localhost/dings/wordpress/wp-json/wc/store/products/";
...
function createHtml(products){
    products.forEach(function(product){
        ...
        `<div class= "jacket">
            ...
            <a href="test2.html?id=${product.id}"> <img src="${product.images[0].src}" alt="${product.name}" class= "image1"></a>
